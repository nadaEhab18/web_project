...
class OldFilter_3 extends StatefulWidget {
  const OldFilter_3({Key? key}) : super(key: key);

  @override
  State<OldFilter_3> createState() => _OldFilter_3State();
}

class _OldFilter_3State extends State<OldFilter_3> {
  ...
  Future<void> _fetchData() async {
    try {
      Response response = await OldFilterRepository().filter_3(gpaId!);
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: TextButton(
                                ...
                                child: const Text('قاعدة التنسيق الثالثة  ',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color:Color(0xff003c60)),),
                              ),
                            ),
