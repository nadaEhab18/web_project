...
import 'package:web_project/pages/Employee/oldFilter_1.dart';
import 'package:web_project/pages/Employee/oldFilter_2.dart';
import 'package:web_project/pages/Employee/oldFilter_3.dart';
import 'package:web_project/pages/Employee/oldFilter_4.dart';
import 'package:web_project/pages/headBar.dart';
import 'package:web_project/shared/app_colors.dart';

class OldStudentsFilter extends StatefulWidget {
  const OldStudentsFilter({Key? key}) : super(key: key);

  @override
  State<OldStudentsFilter> createState() => _OldStudentsFilterState();
}

class _OldStudentsFilterState extends State<OldStudentsFilter> {
  @override
                      ...
                      child: Column(
                        children: [
                          ...
                          FilterRule(
                            ...
                            filterSubTitle: 'طلاب ذوى الاحتياجات الخاصة', pagePath: () {
