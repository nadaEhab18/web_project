...
class NewFilter_3 extends StatefulWidget {
  const NewFilter_3({Key? key}) : super(key: key);

  @override
  State<NewFilter_3> createState() => _NewFilter_3State();
}

class _NewFilter_3State extends State<NewFilter_3> {
  ...
  Future<void> _fetchData() async {
    try {
      Response response = await NewFilterRepository().filter_3();
