...
class Reject_3 extends StatefulWidget {
  const Reject_3({Key? key}) : super(key: key);

  @override
  State<Reject_3> createState() => _Reject_3State();
}

class _Reject_3State extends State<Reject_3> {
  ...
  Future<void> _fetchData() async {
    try {
      Response response = await RecieviedRequestRepository().getReject_3();
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: TextButton(
                                ...
                                child: const Text('الحالة الثالثة  ',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color:Color(0xff003c60)),),
                              ),
                            ),
