...
class NewFilter_1 extends StatefulWidget {
  const NewFilter_1({Key? key}) : super(key: key);

  @override
  State<NewFilter_1> createState() => _NewFilter_1State();
}

class _NewFilter_1State extends State<NewFilter_1> {
  ...
  Future<void> _fetchData() async {
    try {
      Response response = await NewFilterRepository().filter_1();
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: TextButton(
                                ...
                                child: const Text('قاعدة التنسيق الاولى  ',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color:Color(0xff003c60)),),
                              ),
                            ),
