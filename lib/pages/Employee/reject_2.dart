...
class Reject_2 extends StatefulWidget {
  const Reject_2({Key? key}) : super(key: key);

  @override
  State<Reject_2> createState() => _Reject_2State();
}

class _Reject_2State extends State<Reject_2> {
  ...
  Future<void> _fetchData() async {
    try {
      Response response = await RecieviedRequestRepository().getReject_2();
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: TextButton(
                                ...
                                child: const Text('الحالة الثانية  ',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color:Color(0xff003c60)),),
                              ),
                            ),
