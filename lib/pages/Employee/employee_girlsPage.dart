...
import 'package:web_project/pages/Employee/emp_showNewGirl.dart';
import 'package:web_project/pages/Employee/emp_showOldGirls.dart';
...
class EmployeeGirls extends StatefulWidget {
  const EmployeeGirls({Key? key}) : super(key: key);

  @override
  State<EmployeeGirls> createState() => _EmployeeGirlsState();
}

class _EmployeeGirlsState extends State<EmployeeGirls> {
  @override
