...
class EmpShowOldGirls extends StatefulWidget {
  const EmpShowOldGirls({Key? key}) : super(key: key);

  @override
  State<EmpShowOldGirls> createState() => _EmpShowOldGirlsState();
}

class _EmpShowOldGirlsState extends State<EmpShowOldGirls> {
                                          ...
                                          child: ListTile(
                                            ...
                                            subtitle: Column(
                                              ...
                                              children: [
                                                ...
                                                Text('النقدير : ${studentScore(oldFemaleModel.gpaId)}'),
