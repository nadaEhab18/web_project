...
import 'package:web_project/models/oldGirls_model.dart';
import 'package:web_project/pages/headBar.dart';
import 'package:web_project/repository/boys_repository.dart';
import 'package:web_project/repository/girls_repository.dart';
import 'package:web_project/shared/app_colors.dart';
import 'package:web_project/widgets/sideBar_menu.dart';


class ShowOldGirls extends StatefulWidget {
  const ShowOldGirls({Key? key}) : super(key: key);

  @override
  State<ShowOldGirls> createState() => _ShowOldGirlsState();
}

class _ShowOldGirlsState extends State<ShowOldGirls> {
late Future<dynamic> showOldestGirl ;

  @override
  void initState() {
    super.initState();
    showOldestGirl= OldGirlsRepository().getOldGirlsData();
  }
                  ...
                  child: Container(
                      ...
                      child: Column(
                       ...
                       const   HeadBar(),
                                ...
                                if (snapshot.hasData) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      final oldFemaleModel = OldGirlsModel.fromJson(responseList[index]);
                                      return Directionality(
                                        textDirection: TextDirection.rtl,
                                        child: Card(
                                          ...
                                          child: ListTile(
                                            ...
                                            title: Text(oldFemaleModel.name,style:TextStyle(fontSize: 22,fontWeight: FontWeight.bold)),
                                            subtitle: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Text('${oldFemaleModel.fatherName}'),
                                                Text('الكلية : ${studentCollage(oldFemaleModel.collegeId)}'),
                                                Text('الفرقة : ${studentLevel(oldFemaleModel.levelId)}'),
                                                Text('التقدير : ${studentScore(oldFemaleModel.gpaId)}'),
                                                Text('المحافظة : ${studentGovernorate(oldFemaleModel.governorateId)}'),
                                                Text('النوع :${studentType(oldFemaleModel.gender)}'),
                                                Text('الديانة : ${studentRegion(oldFemaleModel.religion)}'),
                                              ],
                                            ),
                                          ),
                                        ),
                          ...
                          //         boyId: '1',
                          //         boyName: 'احمد ايهاب',
                          //         boyCollage: 'حاسبات و الذكاء الاصطناعى',
                          //         boyLevel: '4',
                          //         boyGovernorate: 'بنى سويف',
                          //         boyNationalID: '30203182200854',
                          //       ),
                          //       BoysDataRow(
                          //         boyId: '1',
                          //         boyName: 'احمد ايهاب',
