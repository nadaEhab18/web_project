...
class ShowNewBoys extends StatefulWidget {
  const ShowNewBoys({Key? key}) : super(key: key);

  @override
  State<ShowNewBoys> createState() => _ShowNewBoysState();
}

class _ShowNewBoysState extends State<ShowNewBoys> {
                                        ...
                                        child: Card(
                                          ...
                                          child: ListTile(
                                            ...
                                            subtitle: Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Text('${newMaleModel.fatherName}'),
                                                Text('الرقم القومى : ${newMaleModel.nationalId}'),
                                                Text('الكلية : ${studentCollage(newMaleModel.collegeId)}'),
                                                Text('الفرقة : ${studentLevel(newMaleModel.levelId)}'),
                                                Text('المحافظة : ${studentGovernorate(newMaleModel.governorateId)}'),
                                                Text('النوع :${studentType(newMaleModel.gender)}'),
                                                Text('الديانة : ${studentRegion(newMaleModel.religion)}'),
                                              ],
                                            ),
                                          ),
                                        ),
